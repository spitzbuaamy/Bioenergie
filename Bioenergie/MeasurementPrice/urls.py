...
urlpatterns = patterns('',
    ...
    url(r'^detail/(?P<pk>\d+)$', MeasurementPriceDetailView.as_view(), name='measurement_price_detail'),
    url(r'^create/$', MeasurementPriceCreateView.as_view(), name='measurement_price_create'),
    url(r'^update/(?P<pk>\d+)$', MeasurementPriceUpdateView.as_view(), name='measurement_price_update'),
    url(r'^delete/(?P<pk>\d+)$', MeasurementPriceDeleteView.as_view(), name='measurement_price_delete'),
