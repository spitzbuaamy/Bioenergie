...
urlpatterns = patterns('',
    ...
    url(r'^pdfanschluss/$', 'Abrechnung.views.pdfAnschlussrechnung', name="pdf_Anschlussrechnung"), #TODO: Fuer Anschlussrechnung wird noch der PK des Objektes benoetigt
